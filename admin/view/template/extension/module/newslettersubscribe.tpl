  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
		...
		<a id="button-send"  class="btn btn-default" onclick="send('index.php?route=extension/module/newslettersubscribe/send&token=<?php echo $token; ?>');" class="button"><?php echo $button_send; ?></a>
											...
											<div class="table-responsive">
												<table id="mail"  class="table table-bordered table-hover">
												  ...
												  <tr>
													...
													<td><textarea id="input-description" class="form-control" placeholder="Email Message Content" rows="10" cols="100" name="message"></textarea></td>
												  </tr>
												</table>
											</div>
