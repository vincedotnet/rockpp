<div class="featured-product-module owl-products">
  <div>
					...
					<div class="product-intro">
						<div class="actions-link2">
							<?php if($config_slide['f_show_addtocart']) { ?>
								<a class="btn-cart" onclick="cart.add('<?php echo $product['product_id']; ?>');">
									<i class="zmdi zmdi-shopping-cart-plus"></i><span class="button"><?php echo $button_cart; ?></span></a>
							<?php } ?>							
						</div>						
					</div>
				</div>
