<div class="ajax-container">
    <div class="register-form-content">
        ...
        <form action="<?php echo $action; ?>" method="post" id="ajax-register-form" enctype="multipart/form-data" class="form-horizontal">
            <fieldset id="account">
                ...
                <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-register-email"><?php echo $entry_email; ?></label>
                    <div class="col-sm-10">
                        <input type="email" name="email" value="<?php echo $email; ?>" placeholder="<?php echo $entry_email; ?>" id="input-register-email" class="form-control" />
                        <!-- Error Email -->
            ...
            <fieldset>
                ...
                <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-register-password"><?php echo $entry_password; ?></label>
                    <div class="col-sm-10">
                        <input type="password" name="password" value="<?php echo $password; ?>" placeholder="<?php echo $entry_password; ?>" id="input-register-password" class="form-control" />
                        <!-- Error Password -->
            ...
            <div class="buttons">
                <div class="pull-right"><?php echo $text_agree; ?>
                    ...
                    <?php } ?>
                    &nbsp;
                    <input type="button" onclick="ocajaxlogin.registerAction();" value="<?php echo $button_continue; ?>" class="btn btn-primary" />
            ...
            <div class="buttons">
                <div class="pull-right">
                    <button type="button" onclick="ocajaxlogin.registerAction();"  class="button"><span><?php echo $button_continue; ?></span></button>
                    <img class="ajax-load-img" alt="" src="<?php echo $loader_img ?>" width="30" height="30" />
                </div>
            </div>
            <?php } ?>
