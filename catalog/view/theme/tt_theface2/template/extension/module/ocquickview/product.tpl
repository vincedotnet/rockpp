    ...
    <div class="col-1 col-sm-5">
		...
		<div class="col-2 col-sm-7">
		  ...
		  <div class="form-group">
				...
				<button class="btn-wishlist" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="addWishlist('<?php echo $product_id; ?>');"><i class="fa fa-heart-o" aria-hidden="true"></i><span><?php echo $button_wishlist; ?></span></button>
				<button class="btn-compare" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="addCompare('<?php echo $product_id; ?>');"><i class="fa fa-exchange" aria-hidden="true"></i><span><?php echo $button_compare; ?></span></button>
			</div> 		  			  
			  <?php if ($price) { ?>
